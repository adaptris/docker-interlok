...
RUN wget -q https://development.adaptris.net/installers/Interlok/3.7.2/base-filesystem.zip && \
    wget -q https://development.adaptris.net/installers/Interlok/3.7.2/runtime-libraries.zip && \
    wget -q https://development.adaptris.net/installers/Interlok/3.7.2/javadocs.zip && \
