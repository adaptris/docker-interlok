...
RUN apk add --no-cache --update ca-certificates openssl bash wget unzip && \
    wget -q https://development.adaptris.net/installers/Interlok/3.7.0/base-filesystem.zip && \
    wget -q https://development.adaptris.net/installers/Interlok/3.7.0/runtime-libraries.zip && \
    wget -q https://development.adaptris.net/installers/Interlok/3.7.0/javadocs.zip && \
