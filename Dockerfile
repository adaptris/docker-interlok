...
RUN wget -q https://development.adaptris.net/installers/Interlok/3.8.0/base-filesystem.zip && \
    wget -q https://development.adaptris.net/installers/Interlok/3.8.0/runtime-libraries.zip && \
    wget -q https://development.adaptris.net/installers/Interlok/3.8.0/javadocs.zip && \
